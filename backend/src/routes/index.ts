...
import asteriskRoutes from "./asteriskRoutes";
import callRoutes from "./callRoutes";
import extensionRoutes from "./extensionRoutes";
import messageSemaphoreRoutes from "./messageSemaphoreRoutes";
...
routes.use(asteriskRoutes);
routes.use(callRoutes);
routes.use(extensionRoutes);
routes.use(messageSemaphoreRoutes);
