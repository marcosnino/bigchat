// @ts-nocheck
// Este arquivo usa Baileys e não é usado quando whatsapp-web.js está ativo
...
// MOCK MODE: Importando tipos mock em vez do Baileys ESM
import {
  WASocket
} from "../../libs/baileysmock_fixed";

// Mock types para desenvolvimento
type MessageUpsertType = "notify" | "append";
type WAMessage = any;
type WAMessageStubType = any;
type WAMessageUpdate = any;
type proto = any;

const downloadMediaMessage = async (msg: any) => null;
const extractMessageContent = (msg: any) => msg;
const getContentType = (msg: any) => "text";
const jidNormalizedUser = (jid: string) => jid;
