...
import SendWhatsAppMedia from "../services/WbotServices/SendWhatsAppMedia-wwjs";
import SendWhatsAppMessage from "../services/WbotServices/SendWhatsAppMessage-wwjs";
...
export const clearHistory = async (
  ...
  const { deletedCount } = await ClearTicketMessagesService({
    ticketId,
    companyId
  });
