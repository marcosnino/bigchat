    ...
    translations: {
      ...
      whatsappModal: {
        ...
        form: {
          ...
          provider: "Tipo de Conexão",
          metaConfig: "Configuração da API Meta",
          phoneNumberId: "Phone Number ID",
          phoneNumberIdHelp: "ID do número de telefone no Meta Business",
          businessAccountId: "WhatsApp Business Account ID",
          businessAccountIdHelp: "ID da conta de negócios do WhatsApp",
          accessToken: "Token de Acesso",
          accessTokenHelp: "Token permanente gerado no Meta Business",
          webhookVerifyToken: "Token de Verificação do Webhook",
          webhookVerifyTokenHelp: "Token usado para verificar o webhook",
          metaApiVersion: "Versão da API",
          metaApiVersionHelp: "Versão da Graph API (ex: v18.0)",
        },
        buttons: {
          okAdd: "Adicionar",
          okEdit: "Salvar",
      ...
      asterisk: {
        ...
        toasts: {
          created: "Conexão Asterisk criada com sucesso!",
          updated: "Conexão Asterisk atualizada com sucesso!",
          deleted: "Conexão Asterisk excluída com sucesso!",
          connected: "Conectado ao Asterisk com sucesso!",
          disconnected: "Desconectado do Asterisk!",
        },
        confirmationModal: {
          deleteTitle: "Excluir",
          deleteMessage: "Tem certeza que deseja excluir esta conexão Asterisk? Todas as chamadas associadas serão perdidas.",
        },
        table: {
          name: "Nome",
          host: "Host",
          status: "Status",
          actions: "Ações",
          empty: "Nenhuma conexão Asterisk configurada",
        },
        modal: {
          add: "Adicionar Conexão Asterisk",
          edit: "Editar Conexão Asterisk",
        },
        form: {
          name: "Nome da Conexão",
          host: "Host/IP do Asterisk",
          ariPort: "Porta ARI",
          sipPort: "Porta SIP",
          wsPort: "Porta WebSocket",
          ariUser: "Usuário ARI",
          ariPassword: "Senha ARI",
          ariApplication: "Aplicação Stasis",
          sipDomain: "Domínio SIP",
          outboundContext: "Contexto de Saída",
          inboundContext: "Contexto de Entrada",
          useSSL: "Usar SSL/HTTPS",
          isActive: "Ativar Conexão",
          notes: "Observações",
        },
        buttons: {
          add: "Adicionar Asterisk",
          edit: "Editar",
          delete: "Excluir",
          connect: "Conectar",
          disconnect: "Desconectar",
      ...
      extension: {
        title: "Ramais",
        toasts: {
          created: "Ramal criado com sucesso!",
          updated: "Ramal atualizado com sucesso!",
          deleted: "Ramal excluído com sucesso!",
        },
        confirmationModal: {
          deleteTitle: "Excluir Ramal",
          deleteMessage: "Tem certeza que deseja excluir este ramal?",
        },
        table: {
          exten: "Ramal",
          callerIdName: "Nome",
        ...
        form: {
          exten: "Número do Ramal",
          password: "Senha SIP",
          callerIdName: "Nome do Identificador",
          callerIdNumber: "Número do Identificador",
          asterisk: "Servidor Asterisk",
          selectAsterisk: "Selecione um servidor",
          user: "Atendente",
          selectUser: "Selecione um atendente",
          context: "Contexto",
          transport: "Transporte",
          codecs: "Codecs",
          maxContacts: "Máx. Conexões",
          webrtcEnabled: "Habilitar WebRTC",
          notes: "Observações",
        },
        buttons: {
          add: "Adicionar Ramal",
      ...
      settings: {
        ...
        options: {
          ...
          fields: {
            ...
            autoAcceptTickets: {
              title: "Aceitar tickets automaticamente",
            },
            sendMsgTransfTicket: {
      ...
      handoffHistory: {
        ...
        empty: "Nenhum atendimento anterior encontrado",
        closed: "Encerrado",
      ...
      ticketActionButtons: {
        ...
        confirmClose: {
          ...
          message: "Tem certeza que deseja encerrar esta conversa? O ticket será movido para fechados.",
          confirm: "Encerrar",
          cancel: "Cancelar",
        },
      },
      ...
      ticketOptionsMenu: {
        ...
        clearHistoryModal: {
          ...
          message: "Tem certeza? Todas as mensagens deste ticket serão removidas permanentemente. Esta ação não pode ser revertida.",
        },
        buttons: {
          delete: "Excluir",
          cancel: "Cancelar",
