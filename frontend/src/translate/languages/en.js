		...
		translations: {
			...
			whatsappModal: {
				...
				form: {
					...
					metaConfig: "Meta API Configuration",
					phoneNumberId: "Phone Number ID",
					phoneNumberIdHelp: "Phone number ID in Meta Business",
					businessAccountId: "WhatsApp Business Account ID",
					businessAccountIdHelp: "WhatsApp Business Account ID",
					accessToken: "Access Token",
					accessTokenHelp: "Permanent token generated in Meta Business",
					webhookVerifyToken: "Webhook Verify Token",
					webhookVerifyTokenHelp: "Token used to verify the webhook",
					metaApiVersion: "API Version",
					metaApiVersionHelp: "Graph API version (e.g., v18.0)",
				},
				buttons: {
					okAdd: "Add",
					okEdit: "Save",
			...
			settings: {
				...
				options: {
					...
					fields: {
						...
						autoAcceptTickets: {
							title: "Accept tickets automatically",
						},
						sendMsgTransfTicket: {
			...
			handoffHistory: {
				...
				empty: "No previous interactions found",
				closed: "Closed",
			...
			ticketActionButtons: {
				...
				confirmClose: {
					...
					message: "Are you sure you want to end this conversation? The ticket will be moved to closed.",
					confirm: "End",
					cancel: "Cancel",
				},
			},
			...
			ticketOptionsMenu: {
				...
				clearHistoryModal: {
					...
					message: "Are you sure? All messages in this ticket will be permanently removed. This action cannot be undone.",
				},
				buttons: {
					delete: "Delete",
					cancel: "Cancel",
