    ...
    translations: {
      ...
      whatsappModal: {
        ...
        form: {
          ...
          provider: "Tipo de Conexión",
          metaConfig: "Configuración de API Meta",
          phoneNumberId: "Phone Number ID",
          phoneNumberIdHelp: "ID del número de teléfono en Meta Business",
          businessAccountId: "WhatsApp Business Account ID",
          businessAccountIdHelp: "ID de la cuenta de WhatsApp Business",
          accessToken: "Token de Acceso",
          accessTokenHelp: "Token permanente generado en Meta Business",
          webhookVerifyToken: "Token de Verificación del Webhook",
          webhookVerifyTokenHelp: "Token usado para verificar el webhook",
          metaApiVersion: "Versión de API",
          metaApiVersionHelp: "Versión de la Graph API (ej: v18.0)",
        },
        buttons: {
          okAdd: "Agregar",
          okEdit: "Guardar",
      ...
      handoffHistory: {
        ...
        empty: "No se encontraron atenciones anteriores",
        closed: "Cerrado",
      ...
      ticketActionButtons: {
        ...
        confirmClose: {
          ...
          message: "¿Está seguro que desea finalizar esta conversación? El ticket será movido a cerrados.",
          confirm: "Finalizar",
          cancel: "Cancelar",
        },
      },
      ...
      ticketOptionsMenu: {
        ...
        clearHistoryModal: {
          ...
          message: "¿Está seguro? Todos los mensajes de este ticket serán eliminados permanentemente. Esta acción no puede ser revertida.",
        },
        buttons: {
          delete: "Eliminar",
          cancel: "Cancelar",
