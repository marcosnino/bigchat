            ...
            <Form>
              <DialogContent dividers>
                ...
                <FormControl
                  ...
                  fullWidth
                >
                  <InputLabel>{i18n.t("whatsappModal.form.provider")}</InputLabel>
                  <Field
                    as={Select}
                    name="provider"
                    ...
                    fullWidth
                  >
                    <MenuItem value="stable">WhatsApp Web (QR Code)</MenuItem>
                    <MenuItem value="meta">API Oficial Meta</MenuItem>
                  </Field>
                </FormControl>

                {/* Campos para API Meta */}
                {values.provider === "meta" && (
                  <div style={{ 
                    ...
                    <h4 style={{ marginTop: 0, marginBottom: 16, color: '#333' }}>
                      {i18n.t("whatsappModal.form.metaConfig")}
                    </h4>
                    <Grid spacing={2} container>
                      <Grid item xs={12} md={6}>
                        <Field
                          as={TextField}
                          label={i18n.t("whatsappModal.form.phoneNumberId")}
                          name="phoneNumberId"
                          fullWidth
                          variant="outlined"
                          margin="dense"
                          helperText={i18n.t("whatsappModal.form.phoneNumberIdHelp")}
                        />
                      </Grid>
                      <Grid item xs={12} md={6}>
                        <Field
                          as={TextField}
                          label={i18n.t("whatsappModal.form.businessAccountId")}
                          name="businessAccountId"
                          fullWidth
                          variant="outlined"
                          margin="dense"
                          helperText={i18n.t("whatsappModal.form.businessAccountIdHelp")}
                        />
                      </Grid>
                      <Grid item xs={12}>
                        <Field
                          as={TextField}
                          label={i18n.t("whatsappModal.form.accessToken")}
                          name="accessToken"
                          fullWidth
                          variant="outlined"
                          margin="dense"
                          type="password"
                          helperText={i18n.t("whatsappModal.form.accessTokenHelp")}
                        />
                      </Grid>
                      <Grid item xs={12} md={6}>
                        <Field
                          as={TextField}
                          label={i18n.t("whatsappModal.form.webhookVerifyToken")}
                          name="webhookVerifyToken"
                          fullWidth
                          variant="outlined"
                          margin="dense"
                          helperText={i18n.t("whatsappModal.form.webhookVerifyTokenHelp")}
                        />
                      </Grid>
                      <Grid item xs={12} md={6}>
                        <Field
                          as={TextField}
                          label={i18n.t("whatsappModal.form.metaApiVersion")}
                          name="metaApiVersion"
                          fullWidth
                          variant="outlined"
                          margin="dense"
                          helperText={i18n.t("whatsappModal.form.metaApiVersionHelp")}
                        />
                      </Grid>
                    </Grid>
                    <p style={{ 
                      ...
                      <strong>Webhook URL:</strong> https://api.drogariasbigmaster.com.br/webhook/meta
                    </p>
                  </div>
                )}
