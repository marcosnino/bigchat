    ...
    const theme = createTheme(
        {
            ...
            palette: {
                type: mode,
                primary: { main: mode === "light" ? "#E62E2E" : "#FFFFFF" },
                textPrimary: mode === "light" ? "#E62E2E" : "#FFFFFF",
                borderPrimary: mode === "light" ? "#E62E2E" : "#FFFFFF",
                ...
                barraSuperior: mode === "light" ? "linear-gradient(to right, #E62E2E, #E62E2E , #E62E2E)" : "#666",
